^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package steve_navigation
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* updating package.xml
* updating launch (`#23 <https://github.com/neobotix/steve_navigation/issues/23>`_)
* multi robot rviz update
* rviz config update
* update for multi robot rviz
* Humble develop (`#18 <https://github.com/neobotix/steve_navigation/issues/18>`_)
  * map_server is used standalone for multi_robot navigation
  * fixes to the default config
  * updating the package description
* Humble update (`#13 <https://github.com/neobotix/steve_navigation/issues/13>`_)
  * minor fixes
  * update readme
...
* adding rviz files
* Feature/multi robot (`#4 <https://github.com/neobotix/steve_navigation/issues/4>`_)
